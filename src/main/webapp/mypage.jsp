...
<body>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8">
			...
			<c:forEach var="i" items="${scrabList }" varStatus="cnt">
				<a href="infogogo.do?no=${i.no }" class="list-group-item">
					<div>
					<div class="board-title">
						<span class="board-category"><img src="/orm/upload/${i.fileName }" width="50" height="50"></span>${i.subject } <span
							class="badge">New</span>
							<a href="/orm/deleteScrab.do?no=${i.no }">
						<button class="pull-right" style="margin-top: 10px" >
						삭제
						</button></a><br>	
					</div>
