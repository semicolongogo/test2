...
<link
 ...
 <script type="text/javascript" src="js/signupFun.js"></script>
...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="container" style="margin-top: 120px">
		<div class="row">
	       <form action="signupFun.do" method="post" id="signupsubmit" name="signupsubmit">
			<div class="main">
				<h3>
					SAMPLE SIGN UP</a>
				</h3>
					...
					<div class="form-group">
						...
						<input type="password" placeholder="비밀번호 확인" class="form-control"
							id="passord2" name="passord2"/>
					</div>
					<font id="chkNotice" size="2" style="font-weight: 900;"></font>
					<div class="row">
