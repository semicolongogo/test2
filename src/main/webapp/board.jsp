		...
		<div class="col-md-8">
			...
			<div class="list-group">
               ...
               <c:forEach var="i" items="${bootList }" varStatus="cnt">
				<a href="infogogo.do?no=${i.no }" class="list-group-item" id="test1" >
					<div class="board-title">
						<span class="board-category"><img src="/orm/upload/${i.fileName }" width="50" height="50"></span>${i.subject }
					...
					<div class="board-meta"
						...
						<p>
							...
							${i.author} 님						 
							<i class="glyphicon glyphicon-comment" id="no">${i.no}</i>
